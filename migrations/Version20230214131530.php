 ...
 */
final class Version20230214131530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reponses (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, commentaires_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, INDEX IDX_1E512EC6A76ED395 (user_id), INDEX IDX_1E512EC617C4B2B0 (commentaires_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
